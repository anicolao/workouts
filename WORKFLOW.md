...
This document outlines the standard workflow for contributing to the `workouts` project.
...
4.  **Artifacts**:
    - All planning and documentation artifacts (e.g., `implementation_plan.md`, `walkthrough.md`) must be committed to the repository (e.g., in `docs/` or root if appropriate) to be visible to reviewers. Local brainstorming files are not sufficient for review.
